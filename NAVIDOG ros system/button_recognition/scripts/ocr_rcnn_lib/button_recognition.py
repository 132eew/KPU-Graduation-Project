...
import sys
sys.path.append('/home/jj/catkin_ws/src/button_recognition/scripts/ocr_rcnn_lib')
from ocr_rcnn_lib.utils.ops import native_crop_and_resize
from ocr_rcnn_lib.utils import visualization_utils as vis_util
...
class ButtonRecognizer:
  def __init__(self, rcnn_path= None, ocr_path=None,
    ...
    # self.pwd = os.path.dirname(os.path.realpath('/home/jj/catkin_ws/src/button_recognition/scripts'))
    self.pwd = '/home/jj/catkin_ws/src/button_recognition/scripts'
  ...
  def warm_up(self):
    image = imageio.imread(os.path.join(self.pwd,'ocr_rcnn_lib/test_panels/1.jpg'))
    self.predict(image)
